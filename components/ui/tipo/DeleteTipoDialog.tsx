...
export function DeleteTipoDialog({ id }: DeleteTipoProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.error("Error", {
        description: "No se pudo eliminar el tipo de evento. Inténtalo de nuevo.",
      });
      console.error(error);
    } finally {
      setIsDeleting(false);
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            con ID <span className="font-bold text-foreground">{id}</span>{" "}
            .
          </AlertDialogDescription>
        </AlertDialogHeader>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction
            ...
            disabled={isDeleting}
          >
            {isDeleting ? "Eliminando..." : "Sí, eliminar tipo"}
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
