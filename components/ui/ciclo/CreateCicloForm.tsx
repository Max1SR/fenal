...
export default function CreateCicloForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      reset();
      router.refresh();
      toast.success("Ciclo agregado correctamente", {
        description: "Los cambios ya son visibles",
      });
    } catch (error) {
      console.error(error);
      toast.error("Hubo un problema", {
        description: "No se pudo agregar el nombre. Intente de nuevo.",
      });
    }
  }
  ...
  return (
    <div className="bg-white p-6 rounded-lg border shadow-sm mb-6 w-full max-w-md">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <Field>
          <FieldLabel htmlFor="nombre">Nombre del Ciclo</FieldLabel>
          ...
          <FieldDescription>
            Este es el nombre del ciclo público que aparecerá en el programa general.
          </FieldDescription>
