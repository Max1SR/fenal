...
interface DeleteSalaProps {
  id: number;
}

export function DeleteSalaDialog({ id }: DeleteSalaProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success("Sala eliminada", {
        description: "La sala ha sido removida de la base de datos.",
      });
      ...
      toast.error("Error", {
        description: "No se pudo eliminar la sala. Inténtalo de nuevo.",
      });
      console.error(error);
    } finally {
      setIsDeleting(false);
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            sala con ID <span className="font-bold text-foreground">{id}</span>{" "}.
          </AlertDialogDescription>
        </AlertDialogHeader>
